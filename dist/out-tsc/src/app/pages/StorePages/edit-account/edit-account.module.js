...
var edit_account_page_1 = require("./edit-account.page");
var routes = [
    {
        path: '',
        component: edit_account_page_1.EditAccountPage
    }
];
var EditAccountPageModule = /** @class */ (function () {
    ...
    EditAccountPageModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [edit_account_page_1.EditAccountPage]
        })
    ], EditAccountPageModule);
    return EditAccountPageModule;
}());
exports.EditAccountPageModule = EditAccountPageModule;
